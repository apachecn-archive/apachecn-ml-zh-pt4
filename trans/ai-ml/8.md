<title>C11461_Solutions_SG_Final_NT</title>
...
3.  您可以测试我们的新应用程序。你会发现人工智能已经做出了正确的举动。
...
1.  本节将讨论如何通过检测手写数字为加密货币交易者提供更高的安全性。我们将假设你是一个新的加密货币交易平台的软件开发人员。您正在实施的最新安全措施要求识别手写数字。使用 MNIST 库来训练神经网络识别数字。你可以在[https://www.tensorflow.org/tutorials/](https://www.tensorflow.org/tutorials/)上阅读更多关于这个数据集的信息。
