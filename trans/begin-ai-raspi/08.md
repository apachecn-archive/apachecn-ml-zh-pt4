...
![A436848_1_En_8_Fig1_HTML.jpg](A436848_1_En_8_Fig1_HTML.jpg)
...
![A436848_1_En_8_Fig2_HTML.jpg](A436848_1_En_8_Fig2_HTML.jpg)
...
![A436848_1_En_8_Fig3_HTML.jpg](A436848_1_En_8_Fig3_HTML.jpg)
...
![A436848_1_En_8_Fig4_HTML.jpg](A436848_1_En_8_Fig4_HTML.jpg)
...
![$$ y = 1/\left(1 + {e}^{-1}\right) $$](A436848_1_En_8_Chapter_IEq2.gif) = 1/(1.3679) = 0.7310 或 out1 = 0.7310
...
![$$ y = 1/\left(1 + {e}^{-0.24}\right) $$](A436848_1_En_8_Chapter_IEq3.gif) = 1/(1.7866) = 0.5597 或 out2 = 0.5597
...
![$$ \left\{\begin{array}{c}\hfill in1\hfill \\ {}\hfill in2\hfill \end{array}\right\} $$](A436848_1_En_8_Chapter_Equa.gif)

同样，下面是加权矩阵:

![$$ \left\{\begin{array}{cc}\hfill {w}_{1,1}\hfill & \hfill {w}_{1,2}\hfill \\ {}\hfill {w}_{2,1}\hfill & \hfill {w}_{2,2}\hfill \end{array}\right\} $$](A436848_1_En_8_Chapter_Equb.gif)

图 [8-5](#Fig5) 显示了这些矩阵运算在交互式 Python 会话中的应用。请注意，只需几条语句就可以得出与手动计算完全相同的结果。

![A436848_1_En_8_Fig5_HTML.jpg](A436848_1_En_8_Fig5_HTML.jpg)
...
![A436848_1_En_8_Fig6_HTML.jpg](A436848_1_En_8_Fig6_HTML.jpg)
...
![A436848_1_En_8_Fig8_HTML.jpg](A436848_1_En_8_Fig8_HTML.jpg)
...
![A436848_1_En_8_Fig9_HTML.jpg](A436848_1_En_8_Fig9_HTML.jpg)
...
![A436848_1_En_8_Fig10_HTML.jpg](A436848_1_En_8_Fig10_HTML.jpg)
...
![A436848_1_En_8_Fig11_HTML.jpg](A436848_1_En_8_Fig11_HTML.jpg)
...
![$$ {\mathrm{e}}_{\mathrm{hidden}}=\left\{\begin{array}{cc}\hfill \frac{w_{1,1}}{w_{1,1} + {w}_{2,1}}\hfill & \hfill \frac{w_{1,2}}{w_{1,2} + {w}_{2,2}}\hfill \\ {}\hfill \frac{w_{2,1}}{w_{2,1} + {w}_{1,1}}\hfill & \hfill \frac{w_{2,2}}{w_{2,2} + {w}_{1,2}}\hfill \end{array}\right\}*\left\{\begin{array}{c}\hfill in1\hfill \\ {}\hfill in2\hfill \end{array}\right\} $$](A436848_1_En_8_Chapter_Equf.gif)
...
![$$ {\mathrm{e}}_{\mathrm{hidden}}=\left\{\begin{array}{cc}\hfill {w}_{1,1}\hfill & \hfill {w}_{1,2}\hfill \\ {}\hfill {w}_{2,1}\hfill & \hfill {w}_{2,2}\hfill \end{array}\right\}*\left\{\begin{array}{c}\hfill in1\hfill \\ {}\hfill in2\hfill \end{array}\right\} $$](A436848_1_En_8_Chapter_Equg.gif)

使用 numpy 的矩阵运算可以很容易地处理前面的矩阵。唯一的问题是矩阵的转置必须在乘法中使用，这也不是问题。图 [8-12](#Fig12) 显示了该误差反向传播示例的实际矩阵运算。

![A436848_1_En_8_Fig12_HTML.jpg](A436848_1_En_8_Fig12_HTML.jpg)
...
![$$ {O}_{k = \frac{1}{1 + {e}^{-{\displaystyle {\sum}_{j=1}^3}\Big({w}_{j, k}\ *\frac{1}{1 + {e}^{-{\displaystyle {\sum}_{j=1}^3}\left({w}_{j, k}*{x}_i\right)}\ }}}} $$](A436848_1_En_8_Chapter_Equh.gif)
...
![$$ y = m x + b $$](A436848_1_En_8_Chapter_Equi.gif)

我当时没有提到它，但这个方程经常被用作 x-y 散点图数据的“最佳拟合”预测值，这是线性回归的基础。考虑图 [8-13](#Fig13) ，这也是 Matt 博客中自动情节序列的起始 gif。

![A436848_1_En_8_Fig13_HTML.jpg](A436848_1_En_8_Fig13_HTML.jpg)
...
应该有一个开始方程来开始这个线性回归技术的讨论。在这种情况下，它是第 [2](02.html) 章线性预测模型中使用的斜线方程。【T2![$$ y = m x + b $$](A436848_1_En_8_Chapter_Equj.gif)
...
![$$ {e}_{m, b} = \frac{1}{N}{\displaystyle \sum_{i=1}^N}{\left({y}_i - \left( m*{x}_i + b\right)\right)}^2 $$](A436848_1_En_8_Chapter_Equk.gif)
...
![A436848_1_En_8_Fig14_HTML.jpg](A436848_1_En_8_Fig14_HTML.jpg)
...
![$$ \frac{\partial }{\partial m} = \frac{2}{N}{\displaystyle \sum_{i=1}^N}-{x}_i\left({y}_i - \left( m{x}_i + b\right)\right) $$](A436848_1_En_8_Chapter_Equl.gif)

![$$ \frac{\partial }{\partial b} = \frac{2}{N}{\displaystyle \sum_{i=1}^N}-\left({y}_i - \left( m{x}_i + b\right)\right) $$](A436848_1_En_8_Chapter_Equm.gif)

在描述计算最佳 m 和 b 值的过程之前，我想先讨论一下全局最小值的概念。图 [8-15](#Fig15) 是带有变量 x 和 y 的解析连续函数的三维(3D)图。

![A436848_1_En_8_Fig15_HTML.jpg](A436848_1_En_8_Fig15_HTML.jpg)
...
![A436848_1_En_8_Fig16_HTML.jpg](A436848_1_En_8_Fig16_HTML.jpg)
...
![A436848_1_En_8_Fig17_HTML.jpg](A436848_1_En_8_Fig17_HTML.jpg)
...
![A436848_1_En_8_Fig18_HTML.jpg](A436848_1_En_8_Fig18_HTML.jpg)
...
![A436848_1_En_8_Fig19_HTML.jpg](A436848_1_En_8_Fig19_HTML.jpg)
...
![A436848_1_En_8_Fig20_HTML.jpg](A436848_1_En_8_Fig20_HTML.jpg)
...
![$$ y = 1.3 x + 0.61 $$](A436848_1_En_8_Chapter_Equn.gif)
...
![A436848_1_En_8_Fig21_HTML.jpg](A436848_1_En_8_Fig21_HTML.jpg)

图 8-21。

ANN global minimum

该调整变成误差函数相对于权重 w <sub>j，k</sub> 的偏导数的函数。这个偏导数用这些符号表示:![$$ \frac{\partial e}{\partial {w}_{j, k}} $$](A436848_1_En_8_Chapter_IEq4.gif)。这个导数也是误差函数的斜率。它是梯度下降算法，沿着斜率下降到全局最小值。

图 [8-22](#Fig22) 显示了三层六节点人工神经网络，这是以下讨论的基础网络。请注意 I、j 和 k 指数，因为在整个过程中遵循这些指数非常重要。

![A436848_1_En_8_Fig22_HTML.jpg](A436848_1_En_8_Fig22_HTML.jpg)
...
![$$ {e}_k = {t}_k - {o}_k $$](A436848_1_En_8_Chapter_Equo.gif)
...
![$$ e = {\displaystyle \sum_{i=1}^N}{\left({t}_n - {o}_n\right)}^2 $$](A436848_1_En_8_Chapter_Equp.gif)

n 是人工神经网络中的节点总数。

该误差函数正是需要对 w <sub>j，k</sub> 进行微分的函数，导致以下形式:

![$$ \frac{\partial e}{\partial {w}_{j, k}} = \frac{\partial }{\partial {w}_{j, k}}\ {\displaystyle \sum_{i=1}^N}\Big({t}_n - {o_{n\ \Big)}}^2 $$](A436848_1_En_8_Chapter_Equq.gif)
...
![$$ \frac{\partial e}{\partial {w}_{j, k}} = \frac{\partial }{\partial {w}_{j, k}}\ \Big({t}_k - {o_{k\ \Big)}}^2 $$](A436848_1_En_8_Chapter_Equr.gif)

下一步是对函数做实际的偏导数。我只是简单地用最少的注释遍历这些步骤，得到最终的方程，而没有延长整个推导过程。

1.  应用的链规则:![$$ \frac{\partial e}{\partial {w}_{j, k}} = \frac{\partial e}{\partial {o}_k}\ *\ \frac{\partial {o}_k}{\partial {w}_{j, k}} $$](A436848_1_En_8_Chapter_IEq5.gif)
2.  o <sub>k</sub> 独立于 w <sub>j，k</sub> 。第一部分= ![$$ -2\left({t}_k - {o}_k\right) $$](A436848_1_En_8_Chapter_IEq6.gif)
3.  输出 o <sub>k</sub> 应用了一个 sigmoid 函数。第二偏= ![$$ \frac{\partial {o}_k}{\partial {w}_{j, k}} $$](A436848_1_En_8_Chapter_IEq7.gif)乙状结肠![$$ \left({\displaystyle {\sum}_j{w}_{j, k}\ *\ {o}_j}\right) $$](A436848_1_En_8_Chapter_IEq8.gif)
4.  乙状结肠的微分是![$$ \frac{\partial }{\partial x}\ sigmoid(x) = sigmoid(x)\ *\ \left(1 - sigmoid(x)\right) $$](A436848_1_En_8_Chapter_IEq9.gif)
5.  结合:![$$ \frac{\partial e}{\partial {w}_{j, k}} = -2\left({t}_k - {o}_{k\ }\right)\kern0.5em *\kern0.5em \mathrm{sigmoid}\left({\displaystyle {\sum}_j{w}_{j, k}\ *\ {o}_j}\right)*\ \left(1 - sigmoid\left({\displaystyle {\sum}_j{w}_{j, k}\ *\ {o}_j}\right)\right)*\ \frac{\partial }{\partial {w}_{j, k}}\left({\displaystyle {\sum}_j{w}_{j, k}\ *\ {o}_j}\right)\Big) $$](A436848_1_En_8_Chapter_IEq10.gif)。注意最后一项是必要的，因为 sigmoid 函数中有求和项。这是链式法则的另一个应用。
6.  简化:![$$ \frac{\partial e}{\partial {w}_{j, k}} = -2\left({t}_k - {o}_{k\ }\right)\kern0.5em *\kern0.5em \mathrm{sigmoid}\left({\displaystyle {\sum}_j{w}_{j, k}\ *\ {o}_j}\right)*\ \left(1 - sigmoid\left({\displaystyle {\sum}_j{w}_{j, k}\ *\ {o}_j}\right)\right)*{o}_j $$](A436848_1_En_8_Chapter_IEq11.gif)

深呼吸，这是我在严格的微积分课后经常做的。这是用于调整权重的最终等式:

![$$ \frac{\partial e}{\partial {w}_{j, k}} = -\left({t}_k - {o}_{k\ }\right)\kern0.5em *\kern0.5em \mathrm{sigmoid}\left({\displaystyle {\sum}_j{w}_{j, k}\ *\ {o}_j}\right)\kern0.5em *\kern0.75em \left(1 - sigmoid\left({\displaystyle {\sum}_j{w}_{j, k}\ *\ {o}_j}\right)\right)*{o}_j $$](A436848_1_En_8_Chapter_Equs.gif)

你还应该注意到等式开头的 2 已经被去掉了。它只是一个比例因子，对于确定误差函数斜率的方向并不重要，而斜率是梯度下降算法的主要关键。我真的想祝贺我的读者，他们已经走了这么远。许多人很难掌握达到这一阶段所需的数学知识。

现在对这个复杂的方程进行物理解释会很有帮助。第一部分![$$ \left({t}_k - {o}_{k\ }\right) $$](A436848_1_En_8_Chapter_IEq12.gif)就是误差，很容易看出来。sigmoid 函数内的求和表达式![$$ {\displaystyle \sum_j}{w}_{j, k}\ *\ {o}_j $$](A436848_1_En_8_Chapter_IEq13.gif)是第 k 个<sub>最终层节点的输入。并且最后一项 o <sub>j</sub> 是来自隐藏层中第 j <sub>个</sub>节点的输出。了解这一物理解释将使创建其他层间误差斜率表达式变得容易得多。</sub>

我陈述了隐藏层误差斜率方程的输入，而不需要经过严格的数学推导。这个表达式依赖于刚才给出的物理解释。

![$$ \frac{\partial e}{\partial {w}_{i, j}} = -\left({e}_j\right)\kern0.5em *\kern0.5em \mathrm{sigmoid}\left({\displaystyle {\sum}_i{w}_{i, j}\ *\ {o}_i}\right)*\ \left(1 - sigmoid\left({\displaystyle {\sum}_i{w}_{i, j}\ *\ {o}_i}\right)\right)*{o}_i $$](A436848_1_En_8_Chapter_Equt.gif)T2】

下一步是演示如何使用前面的误差斜率表达式计算新的权重。其实很简单，如下式所示:

![$$ new\ {w}_{j, k} = old\ {w}_{j, k} - \alpha *\ \frac{\partial e}{\partial {w}_{j, k}} $$](A436848_1_En_8_Chapter_Equu.gif)
...
![A436848_1_En_8_Fig23_HTML.jpg](A436848_1_En_8_Fig23_HTML.jpg)
...
![$$ \frac{\partial e}{\partial {w}_{j, k}} = -\left({t}_k - {o}_k\right)*\mathrm{sigmoid}\left({\displaystyle {\sum}_j{w}_{j, k}\ *\ {o}_j}\right)*\ \left(1 - sigmoid\left({\displaystyle {\sum}_j{w}_{j, k}\ *\ {o}_j}\right)\right)*{o}_j $$](A436848_1_En_8_Chapter_Equx.gif)

替换这些值，如下图所示:

![$$ \left({t}_k - {o}_k\right) $$](A436848_1_En_8_Chapter_IEq14.gif) = e <sub> 1 </sub> = 0.96

![$$ \left({\displaystyle {\sum}_j{w}_{j, k}\ *\ {o}_j}\right) $$](A436848_1_En_8_Chapter_IEq15.gif) = (2.0 * 0.6) + (3.0 * 0.4) = 2.4

sigmoid = ![$$ \frac{1}{\left(1 + {e}^{-2.4}\right)} $$](A436848_1_En_8_Chapter_IEq16.gif) = 0.9168
...
![A436848_1_En_8_Fig24_HTML.jpg](A436848_1_En_8_Fig24_HTML.jpg)
...
对于一个 36 节点的三层人工神经网络，我以前用过，平均值是![$$ \frac{1}{\sqrt{36}} $$](A436848_1_En_8_Chapter_IEq17.gif)或 0.16667。图 [8-25](#Fig25) 显示了该平均值的正态概率分布，也清楚地显示了 2 个近似标准偏差。

![A436848_1_En_8_Fig25_HTML.jpg](A436848_1_En_8_Fig25_HTML.jpg)
...
![A436848_1_En_8_Fig26_HTML.jpg](A436848_1_En_8_Fig26_HTML.jpg)
...
![$$ {e}_k = {t}_k - {o}_k $$](A436848_1_En_8_Chapter_Equy.gif)
...
![$$ g d\left({w}_{j, k}\right) = \alpha *\ {e}_{k\ }\ *\ sigmoid\left({o}_k\right)\ *\ \left(1 - sigmoid\left({o}_k\right)\right)\ *\ {o}_j^T $$](A436848_1_En_8_Chapter_Equaa.gif)
...
![A436848_1_En_8_Fig27_HTML.jpg](A436848_1_En_8_Fig27_HTML.jpg)
