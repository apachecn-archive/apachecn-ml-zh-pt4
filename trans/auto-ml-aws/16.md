...
在 [*第 10 章*](B17649_10_ePub.xhtml#_idTextAnchor133) 、*机器学习软件开发生命周期(MLSDLC)简介*中，我们重点介绍了由数据科学家、ML 工程师以及平台、应用、数据和安全专家组成的跨职能团队如何为成功实施自动化 MLSDLC 流程做出贡献。通过使用 *ACME web 应用*的实际例子，您了解了这些不同的角色是如何相互作用的，以及为什么他们的领域专业知识和工件贡献对于项目的成功如此重要。
